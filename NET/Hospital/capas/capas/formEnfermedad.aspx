        ...
        <div>
            <table class="auto-style1">
                ...
                <tr>
                    ...
                    <td>
                        <asp:Button ID="btnveridenf" runat="server" Text="Verificar ID" OnClick="btnveridenf_Click" />
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:Button ID="btnCEnf" runat="server" Text="Crear Enfermedad" OnClick="btnCEnf_Click" />
                    </td>
                    <td>
