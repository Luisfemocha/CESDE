    ...
    <form id="form1" runat="server">
        <div>
            <table class="auto-style1">
                ...
                <tr>
                    <td>
                        <asp:Button ID="btnCE" runat="server" Text="Crear Empleado" OnClick="btnCE_Click" />
                    </td>
                    <td>
            ...
            <table class="auto-style1">
                ...
                <tr>
                    ...
                    <td class="auto-style2">
                        <asp:Button ID="btnveride2" runat="server" Text="Verificar ID" OnClick="btnveride2_Click" />
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:Button ID="btnBE" runat="server" Text="Borrar Empleado" OnClick="btnBE_Click" />
                    </td>
                    <td>
            ...
            <table class="auto-style1">
                ...
                <tr>
                    ...
                    <td>
                        <asp:Button ID="btnveride3" runat="server" Text="Verificar ID" OnClick="btnveride3_Click" />
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:Button ID="btnAE" runat="server" Text="Actualizar Empleado" OnClick="btnAE_Click" />
                    </td>
                    <td>
            ...
            <table class="auto-style1">
                ...
                <tr>
                    ...
                    <td class="auto-style2">
                        <asp:Button ID="btnveride4" runat="server" Text="Verificar ID" OnClick="btnveride4_Click" />
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:Button ID="btnLE" runat="server" Text="Leer Empleado" OnClick="btnLE_Click" />
                    </td>
                    <td>
